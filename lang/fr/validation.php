...
return [
    ...
    */
    ...
    | marqueur d'attribut par quelque chose de plus convivial comme
    | "Adresse e-mail" au lieu de "email". Cela nous aide simplement
    | à rendre notre message plus expressif.
    |
    */
