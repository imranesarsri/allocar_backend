...
return [
    ...
    | قواعد الحجم. لا تتردد في تعديل هذه الرسائل هنا.
    |
    */
    ...
    'ascii' => 'يجب أن يحتوي حقل :attribute على أحرف أبجدية رقمية ذات بايت واحد ورموز فقط.',
    ...
    'password' => [
        ...
        'uncompromised' => 'ظهر :attribute المقدم في تسريب للبيانات. يرجى اختيار :attribute آخر.',
    ],
    ...
    | تحديد سطر لغة مخصص لقاعدة سمة معينة.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | السطور التالية تستخدم لاستبدال العنصر النائب للسمة
    | بشيء أكثر وضوحًا للقارئ مثل "عنوان البريد الإلكتروني" بدلاً من
    | "email". هذا يساعدنا ببساطة في جعل رسالتنا أكثر تعبيرًا.
    |
    */
